...
if __name__ == '__main__':
    ...
    if N ==3:
        ...
        saveList.append(max(emtpyList[1] + emtpyList[2], emtpyList[0] + emtpyList[2]))
    #print(saveList)
    if N>3:
        saveList.append(emtpyList[0])
        saveList.append(max(emtpyList[0] + emtpyList[1], emtpyList[1]))
        saveList.append(max(emtpyList[1] + emtpyList[2], emtpyList[0] + emtpyList[2]))
        for j in range(3,N):
            saveList.append(max(saveList[j-3] + emtpyList[j-1] + emtpyList[j] , saveList[j-2] + emtpyList[j]))
